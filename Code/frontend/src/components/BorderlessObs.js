...
const initialState = {
    ...
    // snake: [[1,2],[2,2],[3,2]],
    mapa: [
        { x: 13, y: 2, }, { x: 12, y: 2, }, { x: 11, y: 2, }, { x: 14, y: 2, }, { x: 15, y: 2, }, { x: 16, y: 2, }, { x: 7, y: 2, }, { x: 8, y: 2, }, { x: 9, y: 2, }, { x: 10, y: 2, },

        { x: 32, y: 2, }, { x: 33, y: 2, }, { x: 24, y: 2, }, { x: 25, y: 2, }, { x: 26, y: 2, }, { x: 30, y: 2, }, { x: 27, y: 2, }, { x: 28, y: 2, }, { x: 29, y: 2, }, { x: 31, y: 2, },

        { x: 35, y: 6, }, { x: 35, y: 7, }, { x: 35, y: 8, }, { x: 35, y: 9, }, { x: 35, y: 10, }, { x: 35, y: 11, }, { x: 35, y: 12, }, { x: 35, y: 5, },
        { x: 13, y: 15, }, { x: 12, y: 15, }, { x: 11, y: 15, }, { x: 14, y: 15, }, { x: 15, y: 15, }, { x: 16, y: 15, }, { x: 7, y: 15, }, { x: 8, y: 15, }, { x: 9, y: 15, }, { x: 10, y: 15, },

        { x: 32, y: 15, }, { x: 33, y: 15, }, { x: 24, y: 15, }, { x: 25, y: 15, }, { x: 26, y: 15, }, { x: 30, y: 15, }, { x: 27, y: 15, }, { x: 28, y: 15, }, { x: 29, y: 15, }, { x: 31, y: 15, },
...
export class SnakeMap3 extends Component {
    constructor(props) {
        super(props);
